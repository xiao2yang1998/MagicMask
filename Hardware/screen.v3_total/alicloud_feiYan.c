...
//	int num_handles;					/**< Max. Feiyan characteristics numbers registered on cloud */
//} cc_context_t;
...
//		emh_arg_ali_format_t	format;	/**< Reference to product TRD document */
//	} product_info;
//	struct{
...
///** Alicloud feiyan attribute value */
//typedef union {
//	bool		boolValue;
//	int			intValue;
//	double		floatValue;
...
//typedef uint8_t ali_att_type_t;
//typedef mx_status (*ali_read_attr)(ali_att_val_t *value);
//typedef mx_status (*ali_write_attr)(ali_att_val_t value);


///** Alicloud feiyan attribute description */
//typedef struct {
//	char*					name;			/**< Attribute name */
//	ali_att_type_t		type;			/**< Attribute value type */
//	ali_read_attr		read_func;		/**< Attribute value read handler, optional if the value is readable*/
//	ali_write_attr		write_func;		/**< Attribute value write handler, optional if the value is writable */
//} ali_attr_t;

//// Characteristic description and handler functions registered by application
//static ali_attr_t *alisds_attr_db = NULL;

//#define ALISDS_ATTR_VAL_MAX_LEN              (1024) 
//#define ALISDS_ATTR_NAME_MAX_LEN             (64) 
...
///**
// * Send attribute value to Feiyan cloud
// */
//static void ali_indicate_local_atts(int attr_handles[], int num);
...
// 
//#define kNoErr                      0		
//mx_status ali_init(const emh_ali_config_t *config, int num_handles)
//{
...
//{
//	mx_status err = kNoErr;
//	ali_indicate_local_atts(changed_handles, context.num_handles);
...
//void ali_indicate_local_atts(int attr_handles[], int num)
//{
